...
words, replicate this document. The deadline is the start time of
February 18 class.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}\DataTypeTok{i =} \DecValTok{1}\OperatorTok{:}\DecValTok{1000}\NormalTok{, }\DataTypeTok{k =} \DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{tibble}\OperatorTok{::}\KeywordTok{as.tibble}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{ifelse}\NormalTok{(k }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{arrange}\NormalTok{(i, k)}
\NormalTok{df}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{e =}\NormalTok{ evd}\OperatorTok{::}\KeywordTok{rgev}\NormalTok{(}\KeywordTok{dim}\NormalTok{(df)[}\DecValTok{1}\NormalTok{]))}
\NormalTok{df}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{latent =}\NormalTok{ beta }\OperatorTok{*}\StringTok{ }\NormalTok{x }\OperatorTok{+}\StringTok{ }\NormalTok{e)}
\NormalTok{df}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(i) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{ifelse}\NormalTok{(latent }\OperatorTok{==}\StringTok{ }\KeywordTok{max}\NormalTok{(latent), }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{%>%}
...
\item
  ...
  data and name the function \texttt{loglikelihood}.
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{loglikelihood <-}\StringTok{ }
\StringTok{  }\ControlFlowTok{function}\NormalTok{(b, df) \{}
\NormalTok{  l <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(i) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{p =} \KeywordTok{exp}\NormalTok{(b}\OperatorTok{*}\NormalTok{x)}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(}\KeywordTok{exp}\NormalTok{(b}\OperatorTok{*}\NormalTok{x))) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(y }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\NormalTok{  l <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(}\KeywordTok{log}\NormalTok{(l}\OperatorTok{$}\NormalTok{p))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{b_seq <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{0.1}\NormalTok{)}
\NormalTok{output <-}\StringTok{ }
\StringTok{  }\KeywordTok{foreach}\NormalTok{ (}\DataTypeTok{b =}\NormalTok{ b_seq,}
           \DataTypeTok{.combine =} \StringTok{"rbind"}\NormalTok{) }\OperatorTok{%do%}\StringTok{ }\NormalTok{\{}
\NormalTok{  l <-}\StringTok{ }\KeywordTok{loglikelihood}\NormalTok{(b, df)}
  \KeywordTok{return}\NormalTok{(l)}
\NormalTok{\}}
\NormalTok{output <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ b_seq, }\DataTypeTok{y =}\NormalTok{ output)}
\KeywordTok{ggplot}\NormalTok{(output, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{TeX}\NormalTok{(}\StringTok{"$}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{beta$"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Loglikelihood"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{lecture_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{result <-}\StringTok{ }\KeywordTok{optim}\NormalTok{(}\DataTypeTok{par =}\NormalTok{ beta,}
                \DataTypeTok{fn =}\NormalTok{ loglikelihood,}
                \DataTypeTok{df =}\NormalTok{ df,}
                \DataTypeTok{method =} \StringTok{"Brent"}\NormalTok{,}
                \DataTypeTok{lower =} \OperatorTok{-}\DecValTok{1}\NormalTok{,}
                \DataTypeTok{upper =} \DecValTok{1}\NormalTok{,}
                \DataTypeTok{control =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{fnscale =} \OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{))}
\NormalTok{result}
\end{Highlighting}
\end{Shaded}
