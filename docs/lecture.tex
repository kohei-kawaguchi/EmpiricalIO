...
\section{Motivations}\label{motivations-5}
...
\tightlist
\item
  \citet{pesendorfer_asymptotic_2008} prove the following statement:
...
\tightlist
\item
  \citet{pesendorfer_asymptotic_2008} also show the following
  statements.
\item
...
\tightlist
\item
  \citet{bajari_estimating_2007} proposes an alternative estimation
  method.
\item
...
\item
  ...
  \citet{ericson_markov-perfect_1995} and
  \citet{doraszelski_computable_2010}.
\item
  \citet{Igami2018}', the paper referred to in the introduction, falls
  into this category.
\end{itemize}

\subsection{\texorpdfstring{\citet{ryan_cost_2012}}{@ryan\_cost\_2012}}\label{ryan_cost_2012}

\begin{itemize}
\tightlist
\item
  \citet{ryan_cost_2012} is one of the earliest applications.
\item
...
##  1     1     1     0 1.02  0.731 -0.169 -1.40      0  0       0      
##  2     1     1     1 1.02  0.731 -0.169 -1.40      1  0.244  -0.00810
##  3     1     1     5 1.02  0.731 -0.169 -1.40      1  0.756   0.459  
##  4     1     1     6 1.02  0.731 -0.169 -1.40      1  0.195   0.391  
##  5     1     1     7 1.02  0.731 -0.169 -1.40      1 -0.311   0.0373 
##  6     1     1     8 1.02  0.731 -0.169 -1.40      1 -1.11   -0.995  
##  7     1     1    10 1.02  0.731 -0.169 -1.40      1 -0.0225 -0.0281 
##  8     1     2     0 0.375 0.418 -0.243 -0.899     0  0       0      
##  9     1     2     1 0.375 0.418 -0.243 -0.899     1  0.244  -0.00810
## 10     1     2     5 0.375 0.418 -0.243 -0.899     1  0.756   0.459  
## # ... with 349,990 more rows, and 3 more variables: xi <dbl>,
## #   c <dbl>, p <dbl>
\end{verbatim}
...
\begin{verbatim}
## [1] -0.01971328 -0.44401874  0.15952459  0.17658106 -0.55495888
## [6] -0.12854864
\end{verbatim}
...
##  9     1     2     1 0.375 0.418 -0.243 -0.899     1  0.244  -0.00810
## 10     1     2     5 0.375 0.418 -0.243 -0.899     1  0.756   0.459  
## # ... with 349,990 more rows, and 6 more variables: xi <dbl>,
...
##  Mean   : 50.50   Mean   :250.5   Mean   : 4.639  
##  3rd Qu.: 75.25   3rd Qu.:375.2   3rd Qu.: 7.000  
##  Max.   :100.00   Max.   :500.0   Max.   :10.000  
##      v_x_1               v_x_2               v_x_3          
##  Min.   :-4.302781   Min.   :-4.542122   Min.   :-3.957618  
##  1st Qu.:-0.685716   1st Qu.:-0.678436   1st Qu.:-0.674487  
##  Median : 0.000103   Median : 0.000444   Median : 0.005891  
##  Mean   :-0.004312   Mean   :-0.001340   Mean   : 0.003736  
##  3rd Qu.: 0.668186   3rd Qu.: 0.670840   3rd Qu.: 0.678349  
##  Max.   : 3.809895   Max.   : 4.313621   Max.   : 4.244194  
##       v_p                 x_1              x_2          
##  Min.   :-4.218131   Min.   :0.0000   Min.   :-1.10735  
##  1st Qu.:-0.670251   1st Qu.:1.0000   1st Qu.:-0.15269  
##  Median : 0.002309   Median :1.0000   Median : 0.19492  
##  Mean   :-0.001305   Mean   :0.8571   Mean   : 0.06936  
##  3rd Qu.: 0.671041   3rd Qu.:1.0000   3rd Qu.: 0.36916  
##  Max.   : 4.074300   Max.   :1.0000   Max.   : 0.75589  
##       x_3                xi          c                p        
...
##        u                  e                 q         
##  Min.   :-200.871   Min.   :-2.6364   Min.   :0.0000  
##  1st Qu.:  -2.202   1st Qu.:-0.3302   1st Qu.:0.0000  
##  Median :   0.000   Median : 0.3634   Median :0.0000  
##  Mean   :  -1.316   Mean   : 0.5760   Mean   :0.1429  
##  3rd Qu.:   1.961   3rd Qu.: 1.2415   3rd Qu.:0.0000  
##  Max.   :  10.731   Max.   :14.0966   Max.   :1.0000
\end{verbatim}
...
##  1     1     0     0  0       0           0 0      0      153 0.306
##  2     1     1     1  0.244  -0.00810     0 0.951  1.93    49 0.098
##  3     1     5     1  0.756   0.459       0 0.974  1.94    38 0.076
##  4     1     6     1  0.195   0.391       0 0.980  1.96    41 0.082
##  5     1     7     1 -0.311   0.0373      0 0.961  1.94    45 0.09 
##  6     1     8     1 -1.11   -0.995       0 0.989  1.99   131 0.262
##  7     1    10     1 -0.0225 -0.0281      0 1.02   2.09    43 0.086
##  8     2     0     0  0       0           0 0      0      170 0.34 
##  9     2     1     1  0.244  -0.00810     0 0.988  2.09    50 0.1  
## 10     2     2     1  0.369   0.472       0 1.04   1.96    37 0.074
...
##  Mean   : 50.50   Mean   : 4.639   Mean   :0.8571  
##  3rd Qu.: 75.25   3rd Qu.: 7.000   3rd Qu.:1.0000  
##  Max.   :100.00   Max.   :10.000   Max.   :1.0000  
##       x_2                x_3                xi          c         
##  Min.   :-1.10735   Min.   :-0.9947   Min.   :0   Min.   :0.0000  
##  1st Qu.:-0.15269   1st Qu.: 0.0000   1st Qu.:0   1st Qu.:0.9417  
##  Median : 0.19492   Median : 0.2970   Median :0   Median :0.9887  
##  Mean   : 0.06936   Mean   : 0.1186   Mean   :0   Mean   :0.8583  
##  3rd Qu.: 0.36916   3rd Qu.: 0.4106   3rd Qu.:0   3rd Qu.:1.0278  
##  Max.   : 0.75589   Max.   : 0.4719   Max.   :0   Max.   :1.1996  
##        p               q                s                y          
##  Min.   :0.000   Min.   : 25.00   Min.   :0.0500   Min.   :-1.9459  
##  1st Qu.:1.921   1st Qu.: 43.00   1st Qu.:0.0860   1st Qu.:-1.3636  
##  Median :1.986   Median : 51.00   Median :0.1020   Median :-1.1579  
##  Mean   :1.718   Mean   : 71.43   Mean   :0.1429   Mean   :-0.9968  
##  3rd Qu.:2.046   3rd Qu.: 73.00   3rd Qu.:0.1460   3rd Qu.:-0.8316  
##  Max.   :2.192   Max.   :191.00   Max.   :0.3820   Max.   : 0.0000
\end{verbatim}
...
##    <int> <dbl> <dbl>   <dbl>    <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
##  1     1     0     0  0       0           0 0      0      153 0.306
##  2     1     1     1  0.244  -0.00810     0 0.951  1.93    59 0.118
##  3     1     5     1  0.756   0.459       0 0.974  1.94    46 0.092
##  4     1     6     1  0.195   0.391       0 0.980  1.96    39 0.078
##  5     1     7     1 -0.311   0.0373      0 0.961  1.94    51 0.102
##  6     1     8     1 -1.11   -0.995       0 0.989  1.99   107 0.214
##  7     1    10     1 -0.0225 -0.0281      0 1.02   2.09    45 0.09 
##  8     2     0     0  0       0           0 0      0      164 0.328
##  9     2     1     1  0.244  -0.00810     0 0.988  2.09    51 0.102
## 10     2     2     1  0.369   0.472       0 1.04   1.96    33 0.066
## # ... with 690 more rows, and 1 more variable: y <dbl>
\end{verbatim}
...
##        t     i     j  v_x_1  v_x_2  v_x_3    v_p   x_1   x_2   x_3
##    <int> <int> <dbl>  <dbl>  <dbl>  <dbl>  <dbl> <dbl> <dbl> <dbl>
##  1     1     1     0  1.16  -1.40  0.0786 -1.15      0 0      0   
##  2     1     1     6  1.16  -1.40  0.0786 -1.15      1 0.780  1.56
##  3     1     2     0 -1.05  -0.149 1.08    0.623     0 0      0   
##  4     1     2     6 -1.05  -0.149 1.08    0.623     1 0.780  1.56
##  5     1     3     0 -0.426 -4.21  0.625  -1.14      0 0      0   
##  6     1     3     6 -0.426 -4.21  0.625  -1.14      1 0.780  1.56
##  7     1     4     0 -0.235  0.463 0.470   0.241     0 0      0   
##  8     1     4     6 -0.235  0.463 0.470   0.241     1 0.780  1.56
##  9     1     5     0  1.19  -0.342 0.169   0.160     0 0      0   
## 10     1     5     6  1.19  -0.342 0.169   0.160     1 0.780  1.56
## # ... with 372,990 more rows, and 3 more variables: xi <dbl>,
## #   c <dbl>, p <dbl>
\end{verbatim}
...
##        t                i               j         
##  Min.   :  1.00   Min.   :  1.0   Min.   : 0.000  
##  1st Qu.: 26.00   1st Qu.:125.8   1st Qu.: 2.000  
##  Median : 51.50   Median :250.5   Median : 5.000  
##  Mean   : 51.26   Mean   :250.5   Mean   : 4.807  
##  3rd Qu.: 77.00   3rd Qu.:375.2   3rd Qu.: 8.000  
##  Max.   :100.00   Max.   :500.0   Max.   :10.000  
##      v_x_1               v_x_2               v_x_3          
##  Min.   :-4.302781   Min.   :-4.542122   Min.   :-3.957618  
##  1st Qu.:-0.685447   1st Qu.:-0.678377   1st Qu.:-0.676638  
##  Median :-0.000461   Median : 0.001435   Median : 0.006281  
##  Mean   :-0.005284   Mean   :-0.001076   Mean   : 0.003433  
##  3rd Qu.: 0.665219   3rd Qu.: 0.671827   3rd Qu.: 0.679273  
##  Max.   : 3.809895   Max.   : 4.313621   Max.   : 4.244194  
##       v_p                 x_1             x_2         
##  Min.   :-4.218131   Min.   :0.000   Min.   :-4.4294  
##  1st Qu.:-0.672011   1st Qu.:1.000   1st Qu.:-0.6108  
##  Median : 0.002166   Median :1.000   Median : 0.7797  
##  Mean   :-0.001402   Mean   :0.866   Mean   : 0.2713  
##  3rd Qu.: 0.674681   3rd Qu.:1.000   3rd Qu.: 1.4766  
##  Max.   : 4.074300   Max.   :1.000   Max.   : 3.0236  
##       x_3                 xi                  c         
##  Min.   :-3.97870   Min.   :-1.444460   Min.   :0.0000  
##  1st Qu.:-0.03238   1st Qu.:-0.286633   1st Qu.:0.9425  
##  Median : 1.18780   Median : 0.000000   Median :0.9886  
##  Mean   : 0.44050   Mean   : 0.009578   Mean   :0.8670  
##  3rd Qu.: 1.64244   3rd Qu.: 0.317352   3rd Qu.:1.0322  
##  Max.   : 1.88767   Max.   : 1.905138   Max.   :1.1996  
##        p               u                  q            
##  Min.   :0.000   Min.   :-284.515   Min.   :0.0000000  
##  1st Qu.:1.562   1st Qu.:  -3.157   1st Qu.:0.0009063  
##  Median :1.902   Median :   0.000   Median :0.0225375  
##  Mean   :1.871   Mean   :  -1.927   Mean   :0.1340483  
##  3rd Qu.:2.394   3rd Qu.:   1.623   3rd Qu.:0.1203147  
##  Max.   :8.211   Max.   :  19.907   Max.   :1.0000000
\end{verbatim}
...
##       x_3                 xi                  c         
##  Min.   :-3.97870   Min.   :-1.444460   Min.   :0.0000  
##  1st Qu.:-0.03238   1st Qu.:-0.286542   1st Qu.:0.9427  
##  Median : 1.18780   Median : 0.000000   Median :0.9886  
##  Mean   : 0.44050   Mean   : 0.009578   Mean   :0.8670  
##  3rd Qu.: 1.62290   3rd Qu.: 0.316516   3rd Qu.:1.0322  
##  Max.   : 1.88767   Max.   : 1.905138   Max.   :1.1996  
##        p               q                 s          
##  Min.   :0.000   Min.   :  5.912   Min.   :0.01182  
##  1st Qu.:1.564   1st Qu.: 17.628   1st Qu.:0.03526  
##  Median :1.902   Median : 28.025   Median :0.05605  
##  Mean   :1.871   Mean   : 67.024   Mean   :0.13405  
##  3rd Qu.:2.392   3rd Qu.:100.446   3rd Qu.:0.20089  
##  Max.   :8.211   Max.   :337.118   Max.   :0.67424  
##        y          
##  Min.   :-2.9837  
##  1st Qu.:-1.9109  
##  Median :-1.5011  
...
##  9     1     5     0  1.19  -0.342 0.169   0.160     0 0      0   
## 10     1     5     6  1.19  -0.342 0.169   0.160     1 0.780  1.56
## # ... with 372,990 more rows, and 5 more variables: xi <dbl>,
...
\begin{verbatim}
##     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
##  -81.021   -6.934   -2.412    7.984    9.370 1473.085
\end{verbatim}
...
\begin{verbatim}
##     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
##  -81.573   -7.522   -2.760    7.532    8.897 1472.575
\end{verbatim}
...
\begin{verbatim}
## [1] -1.47333937 -0.46008664 -1.68877135  0.02821127 -0.24460643
\end{verbatim}
...
\begin{verbatim}
##           [,1]      [,2]       [,3]      [,4]        [,5]
## [1,] -1.069181 2.0000495 -0.6051149 0.6539103  0.06625095
## [2,] -1.675026 0.0086362  1.1638739 1.9162913 -1.22437208
\end{verbatim}
...
\begin{verbatim}
##           x1         x2
## 1 -0.8820088 -0.6831293
## 2 -1.5748321  0.1316401
## 3  0.2474319  0.3762030
## 4  1.1563445  1.2740152
## 5  0.9506635  0.3092848
\end{verbatim}
