...
\item
  ...
  regression for \eqref{eq:reducedform}. But this does not mean that \(A\)
  and \(B\) are separately estimated.
\item
...
The deadline is the \textbf{start time of February 25 class}.
...
is normalized at 1. The wage \(w_t\) is an i.i.d. exponential of normal
random variable with mean 0 and standard deviation \(\sigma_{w}\).
...
\item
  ...
  \(k_{jt}\), \(\omega_{jt}\), and \(l_{jt}\) under the given parameter
  values according to the above production function and name it
  \texttt{log\_production}.
\end{enumerate}
...
\item
  ...
  \(\eta_{jt}\), \(k_{jt}\), and \(w_t\). Write a function to return the
  optimal log labor given the variables and parameters and name it
  \texttt{log\_labor\_choice}.
\end{enumerate}
...
\item
  ...
  additional input and name it \texttt{log\_labor\_choice\_error}.
\end{enumerate}
...
\tightlist
\item
  Draw \(k_{j0}\) from an i.i.d. normal distribution with mean 1 and
  standard deviation 0.5. Draw \(\omega_{j0}\) from its stationary
...
\tightlist
\item
  Compute the labor and investment choice of period 1. For labor choice,
  compute both types of labor choices.
\end{enumerate}
...
\hline
k & 10000 & 0.9809540 & 0.5827349 & -1.2846624 & 3.4715184\\
\hline
omega & 10000 & -0.0042518 & 0.6947047 & -2.4722527 & 2.5482112\\
\hline
wage & 10000 & 1.2999738 & 1.0034241 & 0.2412463 & 2.9228370\\
\hline
iota & 10000 & -0.0000634 & 0.0502874 & -0.1841453 & 0.1715419\\
\hline
l & 10000 & 3.9635027 & 8.0655395 & 0.0095922 & 139.0681340\\
\hline
l\_error & 10000 & 3.9729395 & 8.1144243 & 0.0095479 & 151.8869846\\
\hline
I & 10000 & 0.1801717 & 0.3180590 & -1.3075169 & 5.9394281\\
\hline
eta & 10000 & 0.0012772 & 0.1999334 & -0.7650371 & 0.7455922\\
\hline
y & 10000 & 2.4763938 & 2.1954979 & -1.6282224 & 32.1811842\\
\hline
y\_error & 10000 & 2.4782811 & 2.2032667 & -1.6281667 & 34.5350569\\
\hline
nu & 10000 & -0.0013588 & 0.4990855 & -2.1513907 & 1.8253882\\
\hline
\end{tabular}
...
## F-statistic: 5.244e+04 on 2 and 9997 DF,  p-value: < 2.2e-16
\end{verbatim}
...
## F-statistic: 4.373e+04 on 2 and 9998 DF,  p-value: < 2.2e-16
\end{verbatim}
...
because we know that it is i.i.d. in the true data generating process.
Do not forget to consider them in the actual data analysis.
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-48-1} \end{center}
...
\item
  ...
  values of the first five rows of the moment evaluated at the true
  parameters.
\end{enumerate}

\begin{verbatim}
## [1] -0.007100535 -0.006621758 -0.009029895
\end{verbatim}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-55-1} \end{center}

\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-55-2} \end{center}

\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-55-3} \end{center}
