...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-32-1} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-49-1} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-56-1} \end{center}

\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-56-2} \end{center}

\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-56-3} \end{center}
...
The deadline is the \textbf{March 11 1:30pm}.

\section{Simulate data}\label{simulate-data-2}

We simulated data from a discrete choice model. There are \(T\) markets
...
\NormalTok{price_xi <-}\StringTok{ }\FloatTok{0.3}
...
##    <int> <int>   <dbl>  <dbl>   <dbl>  <dbl>
##  1     1     1 -0.218   0.527 -0.616  -0.335
##  2     2     1 -0.545   0.887 -1.27   -1.32 
##  3     3     1 -0.275  -1.08   0.0475 -0.410
##  4     4     1  0.0276  0.677  0.121  -0.566
##  5     5     1  0.970   0.952  1.46    0.364
##  6     6     1 -2.20   -2.03   0.0692  1.00 
##  7     7     1  1.95   -0.211 -0.390  -1.59 
##  8     8     1  0.180   0.656 -0.248  -2.43 
##  9     9     1  0.415  -1.67  -0.573   0.833
## 10    10     1  0.647  -0.450  0.255  -0.628
...
##  1     1     1     0 -0.218 0.527 -0.616 -0.335     0  0       0          0
##  2     1     1     4 -0.218 0.527 -0.616 -0.335     1  0.297   0.209      0
##  3     1     1     6 -0.218 0.527 -0.616 -0.335     1  0.391  -0.0514     0
##  4     1     1     7 -0.218 0.527 -0.616 -0.335     1  0.0373  0.194      0
##  5     1     1     8 -0.218 0.527 -0.616 -0.335     1 -0.995  -0.0269     0
##  6     1     1     9 -0.218 0.527 -0.616 -0.335     1  0.310  -0.689      0
##  7     1     1    10 -0.218 0.527 -0.616 -0.335     1 -0.0281 -0.207      0
##  8     1     2     0 -0.545 0.887 -1.27  -1.32      0  0       0          0
##  9     1     2     4 -0.545 0.887 -1.27  -1.32      1  0.297   0.209      0
## 10     1     2     6 -0.545 0.887 -1.27  -1.32      1  0.391  -0.0514     0
...
\begin{verbatim}
## [1] -0.68217552  1.05418040  0.16787113  0.26895893 -0.68735413  0.01863627
\end{verbatim}
...
##  1st Qu.: 25.75   1st Qu.:125.8   1st Qu.: 2.000   1st Qu.:-0.685630  
##  Median : 50.50   Median :250.5   Median : 5.000   Median : 0.000166  
##  Mean   : 50.50   Mean   :250.5   Mean   : 4.829   Mean   :-0.004342  
##  3rd Qu.: 75.25   3rd Qu.:375.2   3rd Qu.: 8.000   3rd Qu.: 0.667946  
##  Max.   :100.00   Max.   :500.0   Max.   :10.000   Max.   : 3.809895  
##      v_x_2               v_x_3                v_p           
##  Min.   :-4.542122   Min.   :-3.957618   Min.   :-4.218131  
##  1st Qu.:-0.678458   1st Qu.:-0.674724   1st Qu.:-0.670276  
##  Median : 0.000095   Median : 0.005968   Median : 0.002173  
##  Mean   :-0.001408   Mean   : 0.003842   Mean   :-0.001432  
##  3rd Qu.: 0.671120   3rd Qu.: 0.678367   3rd Qu.: 0.670915  
##  Max.   : 4.313621   Max.   : 4.244194   Max.   : 4.074300  
##       x_1              x_2                 x_3                 xi   
##  Min.   :0.0000   Min.   :-0.994676   Min.   :-0.73538   Min.   :0  
##  1st Qu.:1.0000   1st Qu.:-0.008095   1st Qu.:-0.21539   1st Qu.:0  
##  Median :1.0000   Median : 0.037283   Median :-0.05139   Median :0  
##  Mean   :0.8571   Mean   : 0.100391   Mean   :-0.08313   Mean   :0  
##  3rd Qu.:1.0000   3rd Qu.: 0.391068   3rd Qu.: 0.19384   3rd Qu.:0  
##  Max.   :1.0000   Max.   : 0.471918   Max.   : 0.67934   Max.   :0  
##        c                p               u                  e          
##  Min.   :0.0000   Min.   :0.000   Min.   :-204.226   Min.   :-2.6364  
##  1st Qu.:0.9449   1st Qu.:1.920   1st Qu.:  -2.010   1st Qu.:-0.3302  
##  Median :0.9882   Median :1.991   Median :   0.000   Median : 0.3635  
##  Mean   :0.8583   Mean   :1.719   Mean   :  -1.145   Mean   : 0.5761  
##  3rd Qu.:1.0293   3rd Qu.:2.047   3rd Qu.:   2.162   3rd Qu.: 1.2415  
##  Max.   :1.1996   Max.   :2.196   Max.   :  10.086   Max.   :14.0966  
##        q         
##  Min.   :0.0000  
##  1st Qu.:0.0000  
##  Median :0.0000  
...
##  1     1     0     0  0        0          0 0      0      157 0.314  0    
##  2     1     4     1  0.297    0.209      0 1.000  2.05    40 0.08  -1.37 
##  3     1     6     1  0.391   -0.0514     0 1.01   2.03    47 0.094 -1.21 
##  4     1     7     1  0.0373   0.194      0 0.952  1.92    67 0.134 -0.852
##  5     1     8     1 -0.995   -0.0269     0 0.955  1.87    55 0.11  -1.05 
##  6     1     9     1  0.310   -0.689      0 1.10   2.04    92 0.184 -0.534
##  7     1    10     1 -0.0281  -0.207      0 1.05   2.14    42 0.084 -1.32 
##  8     2     0     0  0        0          0 0      0      176 0.352  0    
##  9     2     1     1 -0.00810 -0.0779     0 1.04   2.02    61 0.122 -1.06 
## 10     2     2     1  0.472   -0.735      0 1.01   2.10    79 0.158 -0.801
## # ... with 690 more rows
\end{verbatim}
...
\begin{verbatim}
##        t                j               x_1              x_2           
##  Min.   :  1.00   Min.   : 0.000   Min.   :0.0000   Min.   :-0.994676  
##  1st Qu.: 25.75   1st Qu.: 2.000   1st Qu.:1.0000   1st Qu.:-0.008095  
##  Median : 50.50   Median : 5.000   Median :1.0000   Median : 0.037283  
##  Mean   : 50.50   Mean   : 4.829   Mean   :0.8571   Mean   : 0.100391  
##  3rd Qu.: 75.25   3rd Qu.: 8.000   3rd Qu.:1.0000   3rd Qu.: 0.391068  
##  Max.   :100.00   Max.   :10.000   Max.   :1.0000   Max.   : 0.471918  
##       x_3                 xi          c                p        
##  Min.   :-0.73538   Min.   :0   Min.   :0.0000   Min.   :0.000  
##  1st Qu.:-0.21539   1st Qu.:0   1st Qu.:0.9449   1st Qu.:1.920  
##  Median :-0.05139   Median :0   Median :0.9882   Median :1.991  
##  Mean   :-0.08313   Mean   :0   Mean   :0.8583   Mean   :1.719  
##  3rd Qu.: 0.19384   3rd Qu.:0   3rd Qu.:1.0293   3rd Qu.:2.047  
##  Max.   : 0.67934   Max.   :0   Max.   :1.1996   Max.   :2.196  
##        q                s                y          
##  Min.   : 21.00   Min.   :0.0420   Min.   :-2.0735  
##  1st Qu.: 44.00   1st Qu.:0.0880   1st Qu.:-1.3041  
##  Median : 55.00   Median :0.1100   Median :-1.0445  
##  Mean   : 71.43   Mean   :0.1429   Mean   :-0.9370  
##  3rd Qu.: 85.00   3rd Qu.:0.1700   3rd Qu.:-0.6405  
##  Max.   :186.00   Max.   :0.3720   Max.   : 0.0000
\end{verbatim}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.6219 -0.1036  0.0000  0.1018  0.5508 
## 
## Coefficients:
##     Estimate Std. Error t value Pr(>|t|)    
## x_1  1.25741    0.18678   6.732  3.5e-11 ***
## x_2  0.17042    0.01648  10.339  < 2e-16 ***
## x_3 -0.71672    0.01818 -39.414  < 2e-16 ***
## p   -1.21675    0.09309 -13.070  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.1723 on 696 degrees of freedom
## Multiple R-squared:  0.974,  Adjusted R-squared:  0.9738 
## F-statistic:  6507 on 4 and 696 DF,  p-value: < 2.2e-16
\end{verbatim}
...
##        i     t   v_x_1   v_x_2  v_x_3    v_p
##    <int> <int>   <dbl>   <dbl>  <dbl>  <dbl>
##  1     1     1  1.80   -1.42   -0.227 -0.756
##  2     2     1  0.0181  0.163  -0.325  0.307
##  3     3     1 -0.938  -0.797   0.216 -0.357
##  4     4     1  1.86    0.624  -0.634  0.682
##  5     5     1 -1.26   -1.96    1.21   1.58 
##  6     6     1 -0.640  -1.11    0.423 -0.953
##  7     7     1 -0.163   0.0833 -1.59  -0.694
##  8     8     1 -0.150  -0.633   1.26  -0.353
##  9     9     1 -2.22   -0.938  -0.551 -0.815
## 10    10     1 -0.550  -0.256  -0.348 -0.411
## # ... with 49,990 more rows
\end{verbatim}
...
\begin{verbatim}
## [1]  1.8137665  1.7743529  1.1355103  0.0138476 -0.6363222  0.7985290
\end{verbatim}
...
##        t     j   x_1      x_2     x_3    xi     c     p     q     s      y
##    <int> <dbl> <dbl>    <dbl>   <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>  <dbl>
##  1     1     0     0  0        0          0 0      0      143 0.286  0    
##  2     1     4     1  0.297    0.209      0 1.000  2.05    39 0.078 -1.30 
##  3     1     6     1  0.391   -0.0514     0 1.01   2.03    63 0.126 -0.820
##  4     1     7     1  0.0373   0.194      0 0.952  1.92    50 0.1   -1.05 
##  5     1     8     1 -0.995   -0.0269     0 0.955  1.87    47 0.094 -1.11 
##  6     1     9     1  0.310   -0.689      0 1.10   2.04   105 0.21  -0.309
##  7     1    10     1 -0.0281  -0.207      0 1.05   2.14    53 0.106 -0.993
##  8     2     0     0  0        0          0 0      0      150 0.3    0    
##  9     2     1     1 -0.00810 -0.0779     0 1.04   2.02    44 0.088 -1.23 
## 10     2     2     1  0.472   -0.735      0 1.01   2.10    87 0.174 -0.545
## # ... with 690 more rows
\end{verbatim}
...
Because this takes time, you may want to parallelize the commutation
...
data to the worker by using \texttt{.export} and \texttt{.package}
options as follows:
...
explicitly call the pacakge every time I call a function. If you have
compiled your functions in a package, you will just have to pass the
package as follows:
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-1} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-2} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-3} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-4} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-5} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-6} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-7} \end{center}
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-89-8} \end{center}
...
\begin{verbatim}
## $par
## [1]  4.0927656  0.2010147 -0.8053223  1.7687700  0.4916767  0.5071025
## [7]  0.4808094  1.0509863
## 
## $value
## [1] 0.0004093943
## 
...
\begin{verbatim}
##         true  estimates
## 1  4.0000000  4.0927656
## 2  0.1836433  0.2010147
## 3 -0.8356286 -0.8053223
## 4  1.5952808  1.7687700
## 5  0.3295078  0.4916767
## 6  0.8204684  0.5071025
## 7  0.5000000  0.4808094
## 8  1.0000000  1.0509863
\end{verbatim}
