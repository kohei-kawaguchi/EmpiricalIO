...
\begin{verbatim}
##            z_1       z_2
## [1,]  5.520052 0.8339971
## [2,] -2.656357 4.1803232
## [3,] -5.084802 2.2470711
\end{verbatim}
...
probability \(\gamma\), moves down with probability \(\kappa\), and
stays at the same with probability \(1 - \gamma\).
...
\varphi^{(\theta_1, \theta_2)}(p) := [I - \beta \Sigma(p) G]^{-1}\Sigma(p)[\Pi + E(p)],
