...
\item
  ...
  exponentiate inside the function. Iterate this untill
...
\begin{center}\includegraphics{lecture_files/figure-latex/unnamed-chunk-151-1} \end{center}
