...
delete 'Diary_cf_PatentExPost'; diary('Diary_cf_PatentExPost');
...
ll = feval(@Likelihood_PatentExPost,x0,1);   % Solve the game once
...
State_simu(:,4,ns) = npe*ones(18,1);% N_pe is fixed by assumption    
    ...
    for t = 1:17                % Loop 2: for each year
        ...
        % In 1988, CAFC grants Rodime legal monopoly
        if t >= 8
            State_simu(t,2,ns) = 1;
            State_simu(t,3,ns) = 0;
            State_simu(t,4,ns) = 0;
...
clear t n1 n2 n3 nb nn no price_old price_new delta_old delta_new...
    ...
    No Nb Nn;
save Result_cf_PatentExPost.mat... 
