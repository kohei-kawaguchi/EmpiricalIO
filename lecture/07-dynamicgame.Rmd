...
- @pesendorfer_asymptotic_2008 prove the following statement:
\begin{equation}
p = \Psi(p).
\end{equation}
...
- @pesendorfer_asymptotic_2008 also show the following statements.
...
\end{equation}
- If $\epsilon_{ia}$ follows an i.i.d. type-I extreme value distribution, both $E_i(\hat{p})$ and the second equation have closed-forms.
...
- @bajari_estimating_2007 proposes an alternative estimation method.
...
- The formal models and their characterization are found in @ericson_markov-perfect_1995 and @doraszelski_computable_2010.
- @Igami2018', the paper referred to in the introduction, falls into this category.

### @ryan_cost_2012
- @ryan_cost_2012 is one of the earliest applications.
