...
- To do this, download [Git](https://git-scm.com/download/win). This allows you to use Git Bash. 
...
-  Open the [link](https://classroom.github.com/a/6Bp_Obm1) and accept the invitation to the GitHub classroom. If you are asked to select your GitHub account, choose `skip to the next step`. The next page gives you a repository url.
...
- Try `Build > Clean and Rebuild` to make sure the project can be compiled properly. 
...
- Some advice:
1. More git command can be found [here](https://docs.github.com/en/github/using-git). They can be exerted in `Git > More > Shell`, or you can download [Git Desktop](https://git-scm.com/download/win). 
1. Pull before you make new changes, otherwise there might be conflicts when you push the changes.  
1. Commit the changes only if you want to push the changes. If you just want to temporarily save the changes locally so that they will not be covered by the remote repostiory in case you pull, use `git stash`. 
...
save(derivative_share_smooth, file = "data/A5_derivative_share_smooth.RData")
```

```{r}
load(file = "data/A5_derivative_share_smooth.RData")
...
save(marginal_cost_estimate, file = "data/A5_marginal_cost_estimate.RData")
```
```{r}
load(file = "data/A5_marginal_cost_estimate.RData")
