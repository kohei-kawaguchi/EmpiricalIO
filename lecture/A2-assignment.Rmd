...
9. Repeat this procedure for $t = 1, \cdots 10$ by updating the capital and anticipated shocks, and name the resulting data frame `df_all`. Use the previously generated `df` as the data for `t = 1`.
```{r, eval  = FALSE}
df_all <- df
for (t in 2:T) {
  # change time index
