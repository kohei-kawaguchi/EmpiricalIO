...
-  Open the [link](ttps://classroom.github.com/a/6Bp_Obm1) and accept the invitation to the Github classroom, if you are asked to choose select your Github account, just choose `skip to the next step`. The next page gives you a repository url.
- Open Rstudio: `File > New Project...> Version Control`.
-  Copy the above-mentioned repository url into the first blank, name the directory `Assignment` and place the project in your favorite location.
