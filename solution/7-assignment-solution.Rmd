...
7. Write a function `simulate_dynamic_decision_across_firms(p, s, G, L, K, T, N, delta)` that returns simulation data for $N$ firm. For firm $i$, set the seed at $i$
...
simulate_dynamic_decision_across_firms <-
  function(p, s, G, L, K, T, N, delta) {
    df <-
      foreach (i = 1:N, .combine = "rbind", .packages = "EmpiricalIO") %dopar% {
        seed <- i
