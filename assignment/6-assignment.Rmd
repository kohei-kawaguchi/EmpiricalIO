...
saveRDS(
  graph, 
  file = "lecture/data/a6/A6_graph_sequential.rds" %>% here::here()
)
```
...
saveRDS(
  graph, 
  file = "lecture/data/a6/A6_graph_simultaneous.rds" %>% here::here()
)
```
```{r}
graph <- 
...
saveRDS(
  result_sequential, 
  file = "lecture/data/a6/A6_estimate_sequential.rds" %>% here::here()
)
```
```{r}
result_sequential <- 
...
saveRDS(
  result_simultaneous, 
  file = "lecture/data/a6/A6_estimate_simultaneous.rds" %>% here::here()
)
```
```{r}
result_simultaneous <- 
