...
df_T
saveRDS(df_T, file = "data/A2_df_T.rds")
```

10. Check the simulated data by making summary table.
```{r}
readRDS(file = "data/A2_df_T.rds")
df_T_summary <-
  foreach (
    i = 1:dim(df_T)[2], 
    .combine = "rbind"
...
saveRDS(result_1st_bw, file = "data/A2_result_1st_bw.rds")
```
```{r, eval = FALSE}
result_1st <-
  npplreg(data = df_T,
          formula = y_error ~ l_error + k + I| k + I,
          bws = result_1st_bw)
saveRDS(result_1st, file = "data/A2_result_1st.rds")
=======
  npplregbw(
    data = df_T,
    formula = y_error ~ l_error + k + I| k + I
...
>>>>>>> 9fb30a57b252fa4603d0f5ca367205ef51a7aa1e
```
```{r}
readRDS(file = "data/A2_df_T.rds")
readRDS(file = "data/A2_result_1st.rds")
summary(result_1st)
result_1st_plot <-
  data.frame(
    actual = df_T$y_error,
...
<<<<<<< HEAD
  npplregbw(data = df_T,
          formula = y ~ l + k + I| k + I)
saveRDS(result_1st_unidentified_bw, 
     file = "data/A2_result_1st_unidentified_bw.rds")
=======
  npplregbw(
    data = df_T,
    formula = y ~ l + k + I| k + I
...
```
```{r, eval = FALSE}
readRDS(file = "data/A2_result_1st_unidentified_bw.rds")
result_1st_unidentified <-
<<<<<<< HEAD
  npplreg(data = df_T,
          formula = y ~ l + k + I| k + I,
          bws = result_1st_unidentified_bw)
saveRDS(result_1st_unidentified, 
     file = "data/A2_result_1st_unidentified.rds")
=======
  npplreg(
    data = df_T,
    formula = y ~ l + k + I| k + I,
...
```
```{r}
readRDS(file = "data/A2_result_1st_unidentified.rds")
