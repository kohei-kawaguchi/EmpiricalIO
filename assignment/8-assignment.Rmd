...
saveRDS(
  output, 
  file = "lecture/data/a8/A8_equilibrium.rds" %>% here::here()
)
```
...
saveRDS(
  df,
  file = "lecture/data/a8/A8_df.rds" %>% here::here()
)
```
```{r}
df <- 
...
saveRDS(
  objective,
  file = "lecture/data/a8/A8_objective.rds" %>% here::here()
)
```
```{r}
objective <- 
...
saveRDS(
  graph,
  file = "lecture/data/a8/A8_CCP_graph.rds" %>% here::here()
)
```
```{r}
graph <- 
...
saveRDS(
  CCP_result, 
  file = "lecture/data/a8/A8_CCP_result.rds" %>% here::here()
)
```
