...
saveRDS(
  graph, 
  file = "lecture/data/a9/A9_second_parametric_graph.rds" %>% here::here()
)
```
```{r}
graph <- 
...
saveRDS(
  result_second_parametric, 
  file = "lecture/data/a9/A9_result_second_parametric.rds" %>% here::here()
)
```
```{r}
result_second_parametric <- 
...
saveRDS(
  graph,
  file = "lecture/data/a9/A9_first_parametric_graph.rds" %>% here::here()
)
```
...
saveRDS(
  result_first_parametric,
  file = "lecture/data/a9/A9_result_first_parametric.rds" %>% here::here()
)
```
