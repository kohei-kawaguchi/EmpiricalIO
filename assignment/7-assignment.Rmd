...
saveRDS(
  df, 
  file = "lecture/data/a7/A7_df.rds" %>% here::here()
)
```
```{r}
df <- 
...
saveRDS(
  graph, 
  file = "lecture/data/a7/A7_NFP_graph.rds" %>% here::here()
)
```
```{r}
graph <- 
...
saveRDS(
  NFP_result, 
  file = "lecture/data/a7/A7_NFP_result.rds" %>% here::here()
)
```
...
saveRDS(
  graph, 
  file = "lecture/data/a7/A7_CCP_graph.rds" %>% here::here()
)
```
```{r}
graph <- 
...
saveRDS(
  CCP_result, 
  file = "lecture/data/a7/A7_CCP_result.rds" %>% here::here()
)
```
