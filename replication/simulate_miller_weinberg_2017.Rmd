...
Simulate data from the following setting: There are 10 periods before a merger and 10 periods after the merger. There are 10 regional markets in each period. In the pre-merger period, there are 1-5 firms. In the post-merger period, firm 1 and 5 merge to be a single firm. Each firm produces and sells a single product in each market each year.
